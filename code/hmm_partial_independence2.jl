...
run_hmm_partial_independence2_leaf_turn_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ0(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, ρ_default=0.0, kwargs...)
...
run_hmm_partial_independence2_leaf_turn_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ1(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, ρ_default=1.0, kwargs...)
...
run_hmm_partial_independence2_leaf_turn_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_ρ=true, kwargs...)
...
run_hmm_partial_independence2_leaf_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_retainbelief_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_leafspatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_leafturn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_leaf_stay_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_retainbelief_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafturn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_leaf_turn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_leaf_stay_turn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafturn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
...
run_hmm_partial_independence2_leaf_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_retainbelief_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_leafspatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_leafturn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_leaf_stay_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_retainbelief_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafturn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_leaf_turn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_leaf_stay_turn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafturn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
...
run_hmm_partial_independence2_leaf_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_retain_belief=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_leafspatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_leafturn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)

run_hmm_partial_independence2_leaf_stay_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafturn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)

run_hmm_partial_independence2_leaf_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafspatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_turn_leafturn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_turn_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafspatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_spatial_leafturn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_spatial_bias=true, add_leaf_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)

run_hmm_partial_independence2_leaf_stay_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafturn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_leafspatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafspatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_turn_leafturn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_turn_bias=true, add_leaf_turn_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_leaf_stay_spatial_leafspatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_βleaf=true, add_stay_bias=true, add_spatial_bias=true, add_leaf_spatial_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
...
run_hmm_partial_independence2_stay_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_turn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_spatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_stay_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_stay_retainbelief_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_stay_turn_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_stay_spatial_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_turn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_spatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_stay_turn_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)
run_hmm_partial_independence2_stay_spatial_γ2_ρ0_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=0.0, kwargs...)

run_hmm_partial_independence2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_retainbelief_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_retain_belief=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_turn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_spatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_stay_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_retainbelief_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_turn_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_spatial_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_turn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_spatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_turn_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)
run_hmm_partial_independence2_stay_spatial_γ2_ρ1_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, ρ_default=1.0, kwargs...)

run_hmm_partial_independence2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_retain_belief=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)

run_hmm_partial_independence2_stay_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)

run_hmm_partial_independence2_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)
run_hmm_partial_independence2_stay_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, add_ρ=true, kwargs...)