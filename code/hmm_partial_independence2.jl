...
run_hmm_partial_independence2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_γ2=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_retain_belief=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, kwargs...)

run_hmm_partial_independence2_stay_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_γ2=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_retainbelief_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_retain_belief=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_turn_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_spatial_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_depletion_factor=true, kwargs...)

run_hmm_partial_independence2_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_turn_bias=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_spatial_bias=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_turn_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_turn_bias=true, add_γ2=true, add_depletion_factor=true, kwargs...)
run_hmm_partial_independence2_stay_spatial_γ2_ρ_depletion(data; kwargs...) = run_hmm_partial_independence2(data; add_leaf=false, add_βleaf=false, add_stay_bias=true, add_spatial_bias=true, add_γ2=true, add_depletion_factor=true, kwargs...)