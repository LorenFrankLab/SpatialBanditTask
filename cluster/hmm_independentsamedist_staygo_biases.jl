...
using CodecZlib
using EM
include("../code/hmm_independentsamedist_staygo.jl")
...
fns = [
("hmm_independentsamedist_staygo_Bgo_Bstay_Bturn_leaf_stay_turn_leafspatial", run_hmm_independentsamedist_staygo_Bgo_Bstay_Bturn_leaf_stay_turn_leafspatial, true),
("hmm_independentsamedist_staygo_Bstay_Bturn_leaf_stay_turn_leafspatial", run_hmm_independentsamedist_staygo_Bstay_Bturn_leaf_stay_turn_leafspatial, true),
("hmm_independentsamedist_staygo_Bgo_Bstay_leaf_stay_turn_leafspatial", run_hmm_independentsamedist_staygo_Bgo_Bstay_leaf_stay_turn_leafspatial, true),

]
base_dir = "../results/hmm_independentsamedist_staygo_biases"
i = parse(Int, ARGS[1])
