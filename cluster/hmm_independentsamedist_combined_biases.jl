...
fns = [
    # ("hmm_independentsamedist_leaf_depletion", run_hmm_independentsamedist_leaf_depletion, true),
    # ("hmm_independentsamedist_leaf_γ2_depletion", run_hmm_independentsamedist_leaf_γ2_depletion, true),
    # ("hmm_independentsamedist_leaf_retainbelief_depletion", run_hmm_independentsamedist_leaf_retainbelief_depletion, true),
    ("hmm_independentsamedist_leaf_stay_depletion", run_hmm_independentsamedist_leaf_stay_depletion, true),
    # ("hmm_independentsamedist_leaf_turn_depletion", run_hmm_independentsamedist_leaf_turn_depletion, true),
    # ("hmm_independentsamedist_leaf_spatial_depletion", run_hmm_independentsamedist_leaf_spatial_depletion, true),
    ...
    ("hmm_independentsamedist_stay_depletion", run_hmm_independentsamedist_stay_depletion, false),
    # ("hmm_independentsamedist_turn_depletion", run_hmm_independentsamedist_turn_depletion, false),
    # ("hmm_independentsamedist_spatial_depletion", run_hmm_independentsamedist_spatial_depletion, false),
