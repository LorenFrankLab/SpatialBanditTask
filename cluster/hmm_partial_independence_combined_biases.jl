...
fns = [
    ...
    # No Leaf
    # ("hmm_partial_independence_ρ0_depletion", run_hmm_partial_independence_ρ0_depletion, false),
    # ("hmm_partial_independence_γ2_ρ0_depletion", run_hmm_partial_independence_γ2_ρ0_depletion, false),
    # ("hmm_partial_independence_retainbelief_ρ0_depletion", run_hmm_partial_independence_retainbelief_ρ0_depletion, false),
    ("hmm_partial_independence_stay_ρ0_depletion", run_hmm_partial_independence_stay_ρ0_depletion, false),
    # ("hmm_partial_independence_turn_ρ0_depletion", run_hmm_partial_independence_turn_ρ0_depletion, false),
    # ("hmm_partial_independence_spatial_ρ0_depletion", run_hmm_partial_independence_spatial_ρ0_depletion, false),
    
    # ("hmm_partial_independence_stay_γ2_ρ0_depletion", run_hmm_partial_independence_stay_γ2_ρ0_depletion, false),
    # ("hmm_partial_independence_stay_retainbelief_ρ0_depletion", run_hmm_partial_independence_stay_retainbelief_ρ0_depletion, false),
    ("hmm_partial_independence_stay_turn_ρ0_depletion", run_hmm_partial_independence_stay_turn_ρ0_depletion, false),
    ("hmm_partial_independence_stay_spatial_ρ0_depletion", run_hmm_partial_independence_stay_spatial_ρ0_depletion, false),
    
    # ("hmm_partial_independence_turn_γ2_ρ0_depletion", run_hmm_partial_independence_turn_γ2_ρ0_depletion, false),
    # ("hmm_partial_independence_spatial_γ2_ρ0_depletion", run_hmm_partial_independence_spatial_γ2_ρ0_depletion, false),
    ("hmm_partial_independence_stay_turn_γ2_ρ0_depletion", run_hmm_partial_independence_stay_turn_γ2_ρ0_depletion, false),
    ("hmm_partial_independence_stay_spatial_γ2_ρ0_depletion", run_hmm_partial_independence_stay_spatial_γ2_ρ0_depletion, false),
    
    # ("hmm_partial_independence_ρ1_depletion", run_hmm_partial_independence_ρ1_depletion, false),
    # ("hmm_partial_independence_γ2_ρ1_depletion", run_hmm_partial_independence_γ2_ρ1_depletion, false),
    # ("hmm_partial_independence_retainbelief_ρ1_depletion", run_hmm_partial_independence_retainbelief_ρ1_depletion, false),
    ("hmm_partial_independence_stay_ρ1_depletion", run_hmm_partial_independence_stay_ρ1_depletion, false),
    # ("hmm_partial_independence_turn_ρ1_depletion", run_hmm_partial_independence_turn_ρ1_depletion, false),
    # ("hmm_partial_independence_spatial_ρ1_depletion", run_hmm_partial_independence_spatial_ρ1_depletion, false),
    
    # ("hmm_partial_independence_stay_γ2_ρ1_depletion", run_hmm_partial_independence_stay_γ2_ρ1_depletion, false),
    # ("hmm_partial_independence_stay_retainbelief_ρ1_depletion", run_hmm_partial_independence_stay_retainbelief_ρ1_depletion, false),
    ("hmm_partial_independence_stay_turn_ρ1_depletion", run_hmm_partial_independence_stay_turn_ρ1_depletion, false),
    ("hmm_partial_independence_stay_spatial_ρ1_depletion", run_hmm_partial_independence_stay_spatial_ρ1_depletion, false),
    
    # ("hmm_partial_independence_turn_γ2_ρ1_depletion", run_hmm_partial_independence_turn_γ2_ρ1_depletion, false),
    # ("hmm_partial_independence_spatial_γ2_ρ1_depletion", run_hmm_partial_independence_spatial_γ2_ρ1_depletion, false),
    ("hmm_partial_independence_stay_turn_γ2_ρ1_depletion", run_hmm_partial_independence_stay_turn_γ2_ρ1_depletion, false),
    ("hmm_partial_independence_stay_spatial_γ2_ρ1_depletion", run_hmm_partial_independence_stay_spatial_γ2_ρ1_depletion, false),
    
    # ("hmm_partial_independence_ρ_depletion", run_hmm_partial_independence_ρ_depletion, false),
    # ("hmm_partial_independence_γ2_ρ_depletion", run_hmm_partial_independence_γ2_ρ_depletion, false),
    # ("hmm_partial_independence_retainbelief_ρ_depletion", run_hmm_partial_independence_retainbelief_ρ_depletion, false),
    ("hmm_partial_independence_stay_ρ_depletion", run_hmm_partial_independence_stay_ρ_depletion, false),
    # ("hmm_partial_independence_turn_ρ_depletion", run_hmm_partial_independence_turn_ρ_depletion, false),
    # ("hmm_partial_independence_spatial_ρ_depletion", run_hmm_partial_independence_spatial_ρ_depletion, false),
    
    # ("hmm_partial_independence_stay_γ2_ρ_depletion", run_hmm_partial_independence_stay_γ2_ρ_depletion, false),
    # ("hmm_partial_independence_stay_retainbelief_ρ_depletion", run_hmm_partial_independence_stay_retainbelief_ρ_depletion, false),
    ("hmm_partial_independence_stay_turn_ρ_depletion", run_hmm_partial_independence_stay_turn_ρ_depletion, false),
    ("hmm_partial_independence_stay_spatial_ρ_depletion", run_hmm_partial_independence_stay_spatial_ρ_depletion, false),
    
    # ("hmm_partial_independence_turn_γ2_ρ_depletion", run_hmm_partial_independence_turn_γ2_ρ_depletion, false),
    # ("hmm_partial_independence_spatial_γ2_ρ_depletion", run_hmm_partial_independence_spatial_γ2_ρ_depletion, false),
    ("hmm_partial_independence_stay_turn_γ2_ρ_depletion", run_hmm_partial_independence_stay_turn_γ2_ρ_depletion, false),
    ("hmm_partial_independence_stay_spatial_γ2_ρ_depletion", run_hmm_partial_independence_stay_spatial_γ2_ρ_depletion, false),
]
