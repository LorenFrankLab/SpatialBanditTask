...
fns = [
    ...
    ("run_hmm_depletion", run_hmm_depletion),
    ("run_hmm_γ2_depletion", run_hmm_γ2_depletion),
    ("run_hmm_retainbelief_depletion", run_hmm_retainbelief_depletion),
    ("run_hmm_stay_depletion", run_hmm_stay_depletion),
    ("run_hmm_turn_depletion", run_hmm_turn_depletion),
    ("run_hmm_spatial_depletion", run_hmm_spatial_depletion),

    ("run_hmm_stay_γ2_depletion", run_hmm_stay_γ2_depletion),
    ("run_hmm_stay_retainbelief_depletion", run_hmm_stay_retainbelief_depletion),
    ("run_hmm_stay_turn_depletion", run_hmm_stay_turn_depletion),
    ("run_hmm_stay_spatial_depletion", run_hmm_stay_spatial_depletion),

    ("run_hmm_turn_γ2_depletion", run_hmm_turn_γ2_depletion),
    ("run_hmm_spatial_γ2_depletion", run_hmm_spatial_γ2_depletion),
    ("run_hmm_stay_turn_γ2_depletion", run_hmm_stay_turn_γ2_depletion),
    ("run_hmm_stay_spatial_γ2_depletion", run_hmm_stay_spatial_γ2_depletion),
]
