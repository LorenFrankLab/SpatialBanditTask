...
fns = [
    ...
    # ("hmm_independent_depletion", run_hmm_independent_depletion),
    # ("hmm_independent_γ2_depletion", run_hmm_independent_γ2_depletion),
    # ("hmm_independent_retainbelief_depletion", run_hmm_independent_retainbelief_depletion),
    ("hmm_independent_stay_depletion", run_hmm_independent_stay_depletion),
    # ("hmm_independent_turn_depletion", run_hmm_independent_turn_depletion),
    # ("hmm_independent_spatial_depletion", run_hmm_independent_spatial_depletion),

    # ("hmm_independent_stay_γ2_depletion", run_hmm_independent_stay_γ2_depletion),
    # ("hmm_independent_stay_retainbelief_depletion", run_hmm_independent_stay_retainbelief_depletion),
    ("hmm_independent_stay_turn_depletion", run_hmm_independent_stay_turn_depletion),
    # ("hmm_independent_stay_spatial_depletion", run_hmm_independent_stay_spatial_depletion),

    # ("hmm_independent_turn_γ2_depletion", run_hmm_independent_turn_γ2_depletion),
    # ("hmm_independent_spatial_γ2_depletion", run_hmm_independent_spatial_γ2_depletion),
    ("hmm_independent_stay_turn_γ2_depletion", run_hmm_independent_stay_turn_γ2_depletion),
    # ("hmm_independent_stay_spatial_γ2_depletion", run_hmm_independent_stay_spatial_γ2_depletion),
]
