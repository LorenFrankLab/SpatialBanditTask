...
#SBATCH -J 'hmm_biases_loocv'
#SBATCH -o ../logs/hmm_biases_loocv-%j.out
#SBATCH -p all
#SBATCH -t 300
#SBATCH -c 8
...
mkdir -p ../results/hmm_biases_loocv
JULIA_NUM_THREADS=8 julia hmm_biases_loocv.jl $SLURM_ARRAY_TASK_ID
