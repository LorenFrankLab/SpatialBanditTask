...
#SBATCH -J 'hmm_combined_biases_loocv'
#SBATCH -o ../logs/hmm_combined_biases_loocv-%j.out
#SBATCH -p all
#SBATCH -t 900
#SBATCH -c 8
...
mkdir -p ../results/hmm_combined_biases_loocv
JULIA_NUM_THREADS=8 julia hmm_combined_biases_loocv.jl $SLURM_ARRAY_TASK_ID
